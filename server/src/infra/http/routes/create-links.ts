  ...
  server.post(
    "/links",
    {
      schema: {
        ...
        description:
          "Creates a shortened URL using a custom alias and the original long URL.",
        tags: ["links"],
        body: z.object({
          originalUrl: z
            .string()
        ...
        response: {
          201: z
            .object({
              id: z
                .string()
                .describe("Unique identifier for the shortened link"),
              originalUrl: z.string().describe("The original long URL"),
              shortenedUrl: z
                .string()
                .describe("The user-defined shortened URL"),
              accessCount: z
                .number()
          ...
          409: z
            .object({
              message: z
                .string()
                .describe("Error message when the alias already exists"),
            })
