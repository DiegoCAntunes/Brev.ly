  ...
  server.get(
    "/links",
    {
      schema: {
        ...
        description:
          "Retrieves a paginated list of all shortened URLs with optional filtering and sorting.",
        tags: ["links"],
        querystring: z.object({
          searchQuery: z
            ...
            .optional()
            .describe(
              "Search term to filter links by original or shortened URL"
            ),
          sortBy: z
              ...
              links: z
                .array(
                  z.object({
                    ...
                    shortenedUrl: z
                      .string()
                      .describe("The shortened/custom URL"),
                    accessCount: z
                      .number()
                      .describe("Number of times this link has been accessed"),
                    createdAt: z
                      .date()
                      .describe("Date and time the link was created"),
                  })
                )
                .describe("List of shortened links"),
              total: z
                .number()
                .describe("Total number of links matching the query"),
            })
